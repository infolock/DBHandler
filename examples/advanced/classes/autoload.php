 ...
 *
 * ====== NOTE =======
 * This autoloader class is self-initing.  The last line of code in this file will issue: XYZCompany\autoloader::getInstance(); to start it up...
 *
 * @example
 ...
 * @example
 * include_once('autoloader.php');
 * autoloader::getInstance()->register("MyClass", "/path/to/MyClass");  // In this instance, calling getInstance actually matters!!
 */
namespace XYZCompany;  // This is just an example namespace... change this!

class autoloader {
    const NAMESPACE_SEPARATOR     = '\\';
    const PRIMARY_PROJECT_NAMESPACE = 'XYZCompany';
    ...
    public static function getInstance() {
        if( !self::$common_autoloader_loaded ) {
